                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          ...
                          children: [
                            ...
                            StreamBuilder<List<LevelRecord>>(
                              stream: queryLevelRecord(
                                queryBuilder: (levelRecord) =>
                                    levelRecord.where('User',
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<LevelRecord> listViewLevelRecordList =
                                    snapshot.data!;
                                return ListView.builder(
                                  padding: EdgeInsets.zero,
                                  shrinkWrap: true,
                                  scrollDirection: Axis.vertical,
                                  itemCount: listViewLevelRecordList.length,
                                  itemBuilder: (context, listViewIndex) {
                                    final listViewLevelRecord =
                                        listViewLevelRecordList[listViewIndex];
                                    return Padding(
